...
public:
    ...
    /**
     ...
     /**
      * Finds the KeyPair for the path m/44'/chainId'/accountNumber' using the method described in
      * <a href="https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0005.md">SEP-0005</a>.
      *
      * @param bip39Seed     The output of BIP0039
      * @param accountNumber The number of the account
      * @return KeyPair with secret
      */
     static KeyPair *fromBip39Seed(QByteArray bip39Seed, int chainId, int accountNumber);
